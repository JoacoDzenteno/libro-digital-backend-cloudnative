...
class UsuarioClientServiceTest {
    ...
    void obtenerUsuario_exitoso_retornaMapa() {
        Map<String, Object> usuarioMock = Map.of("id", 3L, "email", "apoderado@colegio.cl");
        ...
        Map<String, Object> resultado = usuarioClientService.obtenerUsuario(3L);

        assertNotNull(resultado);
        assertEquals("apoderado@colegio.cl", resultado.get("email"));
    }
    ...
    void existeUsuario_existente_retornaTrue() {
        Map<String, Object> usuarioMock = Map.of("id", 3L);
        ...
        assertTrue(usuarioClientService.existeUsuario(3L));
    }
